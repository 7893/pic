...
|  |   +-------------+     +-------------+     +--------------------------+       |  |
|  |   |      D1     |     |      R2     |     |        Vectorize         |       |  |
|  |   |   20k rows  |     |    images   |     |    20k x 1024-dim        |       |  |
...
> See [Architecture & Algorithms](docs/ARCHITECTURE.md) for details on distributed locking and quota management.
